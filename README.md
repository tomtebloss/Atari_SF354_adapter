...
| Start by desoldering the two 14 pin DIN connectors from the old pcb. Choose whatever value for the small ones. I did 1uF on the 1206 SMD ceramic capacitor and 0,1uF on the 0805 cap. Otherwise just do 1uF on the through hole. It doesn't matter really. Choose the placement closest to the connector you are going to use to power your drive. Solder in the USB-C connector. Then the 4 pin BERG connector for power. Choose a spot. Or solder wire directly to the board. You will need a female-female 4-pin power cable if you soldered in a connector on the pcb. Then solder 34 pin IDC connector and then one large 47 uF electrolytic capacitor. Choose through hole or surface mount. Either is fine. Then one or two 14 pin DIN connector. | <img title="pcb soldered - top side" style="width:54%" src="images/pcb soldered top.jpg">   <img title="pcb soldered - bottom side" style="width:45%" src="images/pcb soldered bottom.jpg">|
| :--- | :---: |
